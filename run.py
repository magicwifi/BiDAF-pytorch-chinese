...
def main():
    ...
    parser.add_argument('--char-channel-width', default=2, type=int)
    parser.add_argument('--char-channel-size', default=100, type=int)
    parser.add_argument('--context-threshold', default=400, type=int)
    parser.add_argument('--dev-batch-size', default=40, type=int)
    parser.add_argument('--test-batch-size', default=40, type=int)
    parser.add_argument('--dev-file', default='dev-v1.1.json')
    parser.add_argument('--test-file', default='test-v1.1.json')
